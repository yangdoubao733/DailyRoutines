...
public unsafe class AutoSellToRetainer : DailyModuleBase
{
    public override ModuleInfo Info { get; } = new()
    {
        Title = "雇员出售快捷键",
        Description = "按住左键Ctrl并右键点击物品时，自动出售物品",
        Category = ModuleCategories.UIOptimization,
    };

    // 保管选项的菜单文本（中文和英文）
    private readonly string[] entrustTexts = ["委托雇员出售"];
    ...
    {
        // 检查Shift键是否按下
        if (!DService.KeyState[VirtualKey.CONTROL]) return;
